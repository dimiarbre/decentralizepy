...
from decentralizepy.node.DPSGDWithPeerSamplerMultipleAvgRoundsDropout import (
    DPSGDWithPeerSamplerMultipleAvgRoundsDropout,
)
from decentralizepy.node.PeerSamplerMultipleAvgRounds import (
    PeerSamplerMultipleAvgRounds,
)
...
if __name__ == "__main__":
    ...
    for r in range(0, procs_per_machine):
        processes.append(
            mp.Process(
                target=DPSGDWithPeerSamplerMultipleAvgRoundsDropout,
                args=[
                    r,
                    m_id,
                    l,
